    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden hero-mesh">
      ...
      >
        ...
        >
          ...
          Registrations Open for CIPCON 2026
        </motion.div>
        ...
        >
          ...
          {/* <img
            src="../assets/img/CIPCON2026_logo.webp"
            alt="CIPCON 2026"
        ...
        >
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-teal-100 text-sm font-accent">
            ...
            25 - 27 September 2026 {/* UPDATE WHEN EXACT DATES CONFIRMED */}
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-teal-100 text-sm font-accent">
      ...
      >
        <div className="text-center mb-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-400/10 border border-teal-400/20 text-teal-300 text-xs font-accent tracking-widest uppercase mb-4">
            {/* <Calendar size={12} /> */}
            📅 25 - 27 September · Raipur
          </div>
        </div>
        <CountdownTimer
          targetDate="2026-09-25T09:00:00" // UPDATE WHEN DATES CONFIRMED
      ...
      <div className="container-custom">
        ...
        >
          <div className="relative p-8 md:p-10 rounded-3xl bg-white border border-teal-100 shadow-xl shadow-teal-900/5">
            {/* Quote mark */}
            <div className="absolute top-6 left-8 text-7xl font-display text-teal-100 leading-none select-none">
              "
            </div>
            <div className="relative z-10 space-y-4 text-teal-700 font-body leading-relaxed text-base md:text-lg pt-6">
              ...
              <p>
                It is with great honor and enthusiasm that we welcome you to{" "}
                <strong className="text-teal-800">
                  CIPCON 2026 – the 47th Annual Conference of the Central
                  Psychiatric Society (Indian Psychiatric Society–CZ){" "}
                </strong>{" "}
                , scheduled from{" "}
                <strong className="text-teal-800">
                  25th to 27th September 2026
                </strong>{" "}
              ...
              <p>
                Organized by the{" "}
                <strong className="text-teal-800">
                  Chhattisgarh Psychiatric Society
                </strong>
                , CIPCON 2026 the flagship academic event of the Central Zone of
                the Indian Psychiatric Society, stands as a significant event
                and professional gathering dedicated to advancing the science
                and practice of psychiatry in the zone.
              </p>
              <p>
                Shifting the focus back to the core issues, the theme of this
                year’s conference,{" "}
                <strong>
                  “From Foundations to Frontiers: Psychiatry in the Current
                  Era,”
                </strong>{" "}
                reflects our commitment to bridging classical principles with
                emerging innovations. As psychiatry evolves in response to
                changing societal needs, technological advancements, and
                expanding neuroscientific insights, this conference aims to
                create a dynamic platform for reflection, dialogue, and future
                direction-setting. A comprehensive scientific program featuring
                leading experts, academicians, clinicians, and researchers from
                across the country awaits to engage in meaningful dialogue and
                explore evolving paradigms in mental health care.
              </p>
              <p>
                <strong className="text-teal-800">CIPCON 2026</strong> is not
                merely an academic event—it is a confluence of ideas,
                experiences, and collaborations that shape the future of mental
                health care in our region and beyond.{" "}
              </p>
              <p>
                Set in the welcoming ambience of{" "}
                <strong className="text-teal-800">Hotel Omaya Garden</strong>,
                the conference venue offers the perfect blend of comfort and
                elegance, ensuring a stimulating and enjoyable experience for
                all participants. We also encourage you to explore the unique
                cultural heritage, natural beauty, and warm hospitality that
                Chhattisgarh has to offer.
              </p>
              <p>
                Your presence and participation are invaluable in making this
                conference intellectually vibrant and truly memorable. We look
                forward to your active engagement and eagerly await welcoming
                you to Raipur.
              </p>
            </div>
            <div className="absolute bottom-6 right-8 text-7xl font-display text-teal-100 leading-none select-none rotate-180">
              "
            </div>
            <div className="mt-8 pt-6 border-t border-teal-50">
              <p className="font-display text-xl font-bold text-teal-800">
                With warm regards, <br />Organizing Committee
              </p>
        ...
        >
          <h3 className="font-display text-3xl font-bold text-teal-800">
          ...
          {committee.map((member, i) => (
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-accent font-semibold text-teal-800 leading-tight">
                  {member.name}
                </p>
                <p className="text-xs text-teal-500 font-body mt-0.5 leading-tight">
                  {member.role}
                </p>
              </div>
            </motion.div>
...
function ThemeSection() {
  ...
  return (
    <section
      ref={ref}
      className="section-padding bg-teal-950 relative overflow-hidden"
    >
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            ...
            <br />
            <span className="gradient-text">Psychiatry in the Current Era</span>
          </h2>
          <p className="font-accent text-xl text-teal-300 font-semibold mb-6">
            Psychiatry 3.0
          </p>
          ...
          <p className="text-teal-200 font-body text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            changes in psychiatry, driven by advances in genetics, neuroscience,
            digital technologies, therapeutics, and models of care. The term
            "transformative" is used deliberately and cautiously, to refer to
            meaningful changes in understanding and treating mental illness,
            integrating the old and the new. Technology being a tool for the
            same.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {psychiatryVersions.map((v, i) => (
            ...
            >
              {/* Glow */}
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-500 bg-gradient-to-br ${v.color}`}
              />

              <div
                className={`inline-flex w-12 h-12 rounded-2xl items-center justify-center bg-gradient-to-br ${v.color} text-white mb-5`}
              >
                {v.icon}
              </div>
              <div className="flex items-center gap-2 mb-2">
                <span
                  className={`text-xs font-accent font-bold uppercase tracking-widest bg-gradient-to-r ${v.color} bg-clip-text text-transparent`}
                >
                  Version {v.version}
                </span>
              </div>
              ...
              <p className="text-teal-300 font-body text-sm leading-relaxed">
                {v.desc}
              </p>
            </motion.div>
          ))}
        ...
        >
          <div className="inline-block px-8 py-4 rounded-2xl bg-gradient-to-r from-teal-600/20 to-lavender-600/20 border border-teal-500/30">
            <p className="font-display text-2xl md:text-3xl text-white font-bold">
              CIPCON 2026 is a preview of the future –
            </p>
            <p className="font-body text-teal-200 mt-2">
              where we use our rich knowledge fine-tuned by the tools of
              technology.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-teal-800 mb-4">
              The Steel City — <span className="gradient-text">Raipur</span>
            </h2>
            <p className="text-teal-600 font-body leading-relaxed text-base md:text-lg mb-6">
              Raipur, the capital of Chhattisgarh, is a fast-growing urban hub
              known for its blend of modern infrastructure and deep-rooted
              cultural heritage. Situated in central India, the city is a major
              center for steel production, trade, and education. Raipur is
              surrounded by lush forests, serene lakes, and ancient temples that
              reflect its rich history. From the sacred Mahant Ghasidas Memorial
              Museum to the tranquil Nandan Van Zoo & Safari, the city offers a
              balance of spirituality, nature, and urban energy. Festivals like
              Bastar Dussehra showcase the region’s vibrant tribal traditions
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {[
                ...
                <span
                  key={tag}
                  className="px-3 py-1.5 rounded-full text-xs font-accent font-medium bg-teal-100 text-teal-700 border border-teal-200"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex gap-3">
              ...
              >
                <span className="flex items-center gap-2">
                  About Venue <ArrowRight size={14} />
                </span>
              </Link>
              <a
                href="https://maps.app.goo.gl/qrWxMsSYwp9Y1Es56"
                target="_blank"
                rel="noopener noreferrer"
          ...
          >
            <div className="col-span-2 rounded-2xl overflow-hidden aspect-video">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://lh3.googleusercontent.com/gps-proxy/ALd4DhFXQ6libwhEKiArFXPiDgIpkRfYaEH7TRULmSl-oEbhgExZoJXOFfHuA6Zt7OB8hb3aXFFddjRVqGN4b-xXxvE1kWbbY8_TTHHM6k2gicQZlfMxaExYg_fsycpBTiE3FedN7UxpyI2IVflrAC45q_wvvwYpBPc6LUFGT894gB1IfMQMnkvDyIqGvA=s1360-w1360-h1020-rw"
            ...
            <div className="rounded-2xl overflow-hidden aspect-square">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://lh3.googleusercontent.com/gps-cs-s/APNQkAFgwJc4rBCUptevSzp8Ne0DHQRSxZaNLnJuWcXijP5Oo4Swiz4AxPpmzgYq1aAjSS84LSvmq1Ksp_VtcWr7Jb8vcom59_DReup2PdYy3PSMYzbb1p53yRZv_Tjq2BD-b5_3N1UQ=s1360-w1360-h1020-rw"
                alt="Energy Park Raipur"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
            <div className="rounded-2xl overflow-hidden aspect-square">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://lh3.googleusercontent.com/gps-cs-s/APNQkAGsqxersOwmCu-1cDMgCoE-rqFI0U_wEwb0fYgU5A8tCwT25eHY6gAf-aOpNpr3CO1Z4MbjUwr32anItwcla_TueLtztvCjS3VtN1-PBNa97v93G2GdNJMGFZoCfb3aCURfuTbe=w1080-h624-n-k-no"
                alt="Raipur"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
